namespace SchoolProject.Receipts
{
    partial class frmFeesReceiptViewer
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnClick
            // 
            btnClick.Location = new Point(530, 720);
            btnClick.Margin = new Padding(4, 3, 4, 3);
            btnClick.Name = "btnClick";
            btnClick.Size = new Size(69, 24);
            btnClick.TabIndex = 0;
            ...
            // btnPrintIt
            // 
            btnPrintIt.Location = new Point(428, 720);
            btnPrintIt.Margin = new Padding(4, 3, 4, 3);
            btnPrintIt.Name = "btnPrintIt";
            btnPrintIt.Size = new Size(69, 24);
            btnPrintIt.TabIndex = 1;
            btnPrintIt.Text = "Print Doc";
